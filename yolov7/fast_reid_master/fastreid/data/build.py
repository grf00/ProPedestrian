...
from yolov7.fast_reid_master.fastreid.config import configurable
from yolov7.fast_reid_master.fastreid.utils import comm
...
_root = os.getenv("FASTREID_DATASETS", "fast_reid_master/datasets")
